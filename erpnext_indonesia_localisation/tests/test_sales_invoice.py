...
from erpnext_indonesia_localisation.erpnext_indonesia_localisation.doc_events.sales_invoice import set_sales_taxes_template_values


@patch("erpnext_indonesia_localisation.erpnext_indonesia_localisation.doc_events.sales_invoice.frappe")
