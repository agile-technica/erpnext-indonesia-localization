...
function append_call_pajakio_api_button(frm){
    frm.add_custom_button(__('Call Pajak.io API'), function() {
        frappe.confirm(
            ...
            function(){
                frappe.call({
                    method: 'indonesia_taxes_and_charges.indonesia_taxes_and_charges.api.pajakio.create_vat_output_js',
                    args: {
                        name: frm.doc.name
                    },
                    callback: function(r) {
...
function append_download_pdf_button(frm){
    frm.add_custom_button(__('Download PDF'), function() {
        frappe.confirm(
            ...
            function(){
                window.open('/api/method/indonesia_taxes_and_charges.indonesia_taxes_and_charges.doctype.vat_output_metadata.vat_output_metadata.convert_base64_to_pdf?docname=' + frm.doc.name, '_blank');
            },
            function(){
            }
        )
...
function append_upload_vat_button(frm){
    frm.add_custom_button(__('Upload VAT'), function() {
        frappe.confirm(
            ...
            function(){
                frappe.call({
                    method: 'indonesia_taxes_and_charges.indonesia_taxes_and_charges.api.pajakio.upload_vat_output',
                    args: {
                        doc: frm.doc.name
                    },
                    callback: function(r) {
